...
namespace ShuffleConsole
{
    ...
    [Serializable]
    internal class PuntuacionSent : Message
    {
        public bool? State { get; set; }
        public int? Position { get; set; }
        public string RoomId { get; set; }
    ...
    [Serializable]
    internal class getPlaylist : Message
    {
        public string Playlist { get; set; }
        public string RoomId { get; set; }
        public int Amount { get; set; }
    ...
    [Serializable]
    internal class ExitMessage : Message
    {
        public string RoomId { get; set; }
        public int Position { get; set; }
    }
    ...
    [Serializable]
    internal class ExitMessageRecived : Message
    {
        public int PositionMinePoistion { get; set; }
        public string RoomId { get; set; }
        public int PositionDelete { get; set; }
    }
