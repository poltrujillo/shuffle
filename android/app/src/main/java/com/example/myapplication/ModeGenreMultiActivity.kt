...
class ModeGenreMultiActivity : AppCompatActivity() {
    var token = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mode_genre_multi)
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                if (response.isSuccessful) {
                    ...
                    val intent = Intent(this@ModeGenreMultiActivity, ConfigurarPartidaMultiActivity::class.java)
