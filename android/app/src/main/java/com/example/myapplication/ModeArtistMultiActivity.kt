...
class ModeArtistMultiActivity : AppCompatActivity() {
    var posicion = 0
    var token = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mode_artist_multi)
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                if (response.isSuccessful) {
                    ...
                    val intent = Intent(this@ModeArtistMultiActivity, ConfigurarPartidaMultiActivity::class.java)
