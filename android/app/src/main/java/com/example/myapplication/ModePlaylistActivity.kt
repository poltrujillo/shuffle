...
class ModePlaylistActivity : AppCompatActivity() {
    var posicion = 0
    var token = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mode_playlist)
        ...
        spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>?, view: android.view.View?, position: Int, id: Long) {
                ...
                if (!imagenUrl.isNullOrEmpty()) {
                    Glide.with(this@ModePlaylistActivity)
                        .load(imagenUrl)
            ...
            CoroutineScope(Dispatchers.IO).launch {
                try {
                    ...
                    if (response.isSuccessful) {
                        ...
                        val intent = Intent(this@ModePlaylistActivity, ConfigurarPartidaActivity::class.java)
